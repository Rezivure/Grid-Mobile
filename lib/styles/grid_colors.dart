...
class GridColors extends ThemeExtension<GridColors> {
  ...
  factory GridColors.light() => const GridColors(
        bg: Color(0xFFFAF8F4),
        bgWarm: Color(0xFFFCFAF6),
        surface: Color(0xFFFFFEFB),
        surface2: Color(0xFFF4F1EB),
        surface3: Color(0xFFE9E5DC),
        text: Color(0xFF0B0D0F),
        text2: Color(0xFF4A4F56),
        text3: Color(0xFF787872),
        text4: Color(0xFFAEAAA1),
        hairline: Color(0xFFEAE5D9),
        hairlineStrong: Color(0xFFD9D3C5),
        mint: Color(0xFF00DBA4),
        mintDim: Color(0xFF00B589),
        mintSoft: Color(0x2900DBA4),
        mintFaint: Color(0xFFE4F6EE),
        amber: Color(0xFFF5B947),
        amberSoft: Color(0xFFFBEDD2),
        danger: Color(0xFFFF6058),
