...
class GridColors extends ThemeExtension<GridColors> {
  ...
  factory GridColors.light() => const GridColors(
        bg: Color(0xFFF8F8F7),
        bgWarm: Color(0xFFFAFAF9),
        surface: Color(0xFFFFFFFF),
        surface2: Color(0xFFF2F2F0),
        surface3: Color(0xFFE7E7E5),
        text: Color(0xFF0B0D0F),
        text2: Color(0xFF4A4F52),
        text3: Color(0xFF7A7976),
        text4: Color(0xFFADADA8),
        hairline: Color(0xFFE3E3E0),
        hairlineStrong: Color(0xFFD0D0CD),
        mint: Color(0xFF00DBA4),
        mintDim: Color(0xFF00B589),
        mintSoft: Color(0x2900DBA4),
