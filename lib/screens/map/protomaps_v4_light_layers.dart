// Vendored from vector_map_tiles_pmtiles 1.5.0 (CC0/public domain — protomaps).
// https://github.com/protomaps/basemaps  /  https://docs.protomaps.com/basemaps/themes#light
//
// Used at runtime to build a MapLibre style JSON for our v2 pmtiles file.

// ignore_for_file: prefer_single_quotes, require_trailing_commas

/// Layers section of the protomaps basemaps v4 "light" style.
const protomapsV4LightLayers = [
  {
    "id": "background",
    "type": "background",
